  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="max-w-md w-full mx-auto">
        <h1 className="text-3xl font-bold mb-4 text-center text-gray-800">Job Configuration</h1>
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6">
          <div className="mb-4">
            <label htmlFor="group_name" className="block text-lg font-medium text-gray-700 mb-2">
              Job Tag
            </label>
            <input
              type="text"
