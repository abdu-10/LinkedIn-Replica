          ...
          <div className="container bg-white w-[40%] mt-[40px] m-auto p-[10px] rounded-[8px] relative">
            ...
            <div className="flex">
              ...
              <div className="ml-5">
                ...
                <p className="-mt-[1px] text-sm rounded-[15px] text-gray-400 border border-gray-500 p-1 w-[120px] cursor-pointer hover:bg-gray-200">
                  <PublicIcon /> Anyone
                  <ArrowDropDownIcon />{" "}
                </p>
              </div>
              ...
              <form onSubmit={(e) => savePost(e)}>
                ...
                <div className="mt-[20px] flex text-gray-600 ml-2 cursor-pointer items-center">
                  ...
                  <div className="ml-2 space-x-3 flex items-center">
                    <p className="hover:rounded-[8px] mr-[60px] hover:bg-gray-200 p-2 text-[14px]">
                      <MessageIcon /> Anyone
                    </p>
                    <button
                      onClick={savePost}
                      ...
                      } w-[80px] rounded-[15px]  p-2 text-[14px] font-bold`}
                      type="submit"
                    >
                      post
                    </button>
