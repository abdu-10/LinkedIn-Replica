...
function MySeekers() {
  return (
    <div>
      <div className="mt-20">
        <SeekersTab />
        <div class="overflow-hidden rounded-lg border mt-20 border-gray-200 shadow-md m-5">
          <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
            ...
            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4">Kakamega</td>
                <td class="px-6 py-4">Abdu@gmail.com</td>
                <td class="px-6 py-4">
