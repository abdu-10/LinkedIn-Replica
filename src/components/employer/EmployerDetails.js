        ...
        <div class="h-full bg-gray-200 p-8">
            <div class="bg-white rounded-lg shadow-xl pb-8">
                ...
                <div class="flex flex-col items-center -mt-20">
                    <img src="https://www.logomaker.com/wpstatic/uploads/2021/10/LogoMaker.jpg" class="w-40 border-4 border-white rounded-full"/>
                    <div class="flex items-center space-x-2 mt-2">
                        <p class="text-2xl">Motos Ltd</p>
                    ...
                    <p class="text-gray-700"> A technology company that builds innovative solutions for
                regulated industries.</p>
                    <p class="text-sm text-gray-500">Pembe Road</p>
                </div>
                    ...
                    <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                        ...
                        <ul class="mt-2 text-gray-700">
                            <li class="flex border-y py-2">
                                ...
                                <span class="text-gray-700">Motos Ltd</span>
                            </li>
                            <li class="flex border-b py-2">
                                <span class="font-bold w-24">Location</span>
                                <span class="text-gray-700">Pembe Road</span>
                            </li>
                            <li class="flex border-b py-2">
                                <span class="font-bold w-24">Phone Number</span>
                                <span class="text-gray-700">+11 998001001</span>
                            </li>
                            <li class="flex border-b py-2">
                                <span class="font-bold w-24">Email</span>
                                <span class="text-gray-700">motos@gmail.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
